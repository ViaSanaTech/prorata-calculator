...
const Index = () => {
  ...
  const calculateExerciseDays = () => {
    ...
    // Parcours de tous les jours du début jusqu'à la fin du mois
    while (isBefore(currentDate, endOfCurrentMonth) || isSameDay(currentDate, endOfCurrentMonth)) {
  ...
  }, [startDate, selectedDays, subscriptionPrice]);
        ...
        <Card className="w-full max-w-xl p-6 shadow-md mt-6 bg-white border-0 animate-in fade-in slide-in-from-bottom-5 duration-500">
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <div className="p-4 bg-gray-50 rounded-lg">
                <p className="text-sm text-gray-500">Prix mensuel complet</p>
                <p className="text-2xl font-bold text-gray-700">{subscriptionPrice.toFixed(2)} €</p>
              </div>
              <div className="p-4 bg-blue-50 rounded-lg border border-blue-100">
                <p className="text-sm text-blue-700">Coût proratisé</p>
